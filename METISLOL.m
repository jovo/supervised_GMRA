function [MRA] = METISLOL( X, TrainGroup, Labels, Opts )
...
MRA         = METISonly(X_train, Opts.GMRAopts, Labels_train, X_test);
%    MRA.debugMRA = MRA;
...
% Opts.LOL_alg = 'DENL';
% [Opts.task, Opts.ks] = set_task_LOL( Opts, size(data_train,2) );
